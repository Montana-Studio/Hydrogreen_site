<?php
/**
 * Template Name: Project Grid 4 Columns
...
<div class="inner">
	...
	?>
	<div class="element grid classic4_cols <?php echo esc_attr($project_item_service); ?> <?php echo esc_attr($project_item_sector); ?>">
	
		<div class="one_fourth gallery4 filterable gallery_type static animated<?php echo esc_attr($key+1); ?>" data-id="post-<?php echo esc_attr($key+1); ?>">
			<?php 
