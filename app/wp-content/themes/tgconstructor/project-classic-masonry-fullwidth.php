<?php
/**
 * Template Name: Project Classic Masonry Fullwidth
...
<div class="inner">
	...
	?>
	<div class="element classic3_cols <?php echo esc_attr($project_item_service); ?> <?php echo esc_attr($project_item_sector); ?>">
