...
$page_postmetas = 
	array (
		...
		*/
		...
		array("section" => "Page Title", "id" => "page_show_title", "type" => "checkbox", "title" => "Display Page Title & Tagline", "description" => "Check this option if you want to display page title and tagline."),
