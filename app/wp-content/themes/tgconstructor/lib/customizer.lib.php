...
function tg_add_panels_and_sections( $wp_customize ) {
    ...
    $wp_customize->add_panel( 'project', array(
        'priority'    => 46,
        'title'       => __( 'Project', THEMEDOMAIN ),
    ) );
    ...
    $wp_customize->add_section( 'project_filterable', array(
    ...
    $wp_customize->add_section( 'project_single', array(
        'title'       => __( 'Single Project Page', THEMEDOMAIN ),
        'panel'		  => 'project',
        'priority'    => 52,
...
function tg_header_setting( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'tg_post_category_color', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_hex_color',
    ) );
    ...
    //Begin Project Tab Settings
    $wp_customize->add_setting( 'tg_project_filterable', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'tg_sanitize_checkbox',
    ) );
    
    $wp_customize->add_setting( 'tg_project_filterable_link', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'tg_sanitize_checkbox',
    ) );
    
    $wp_customize->add_setting( 'tg_project_filterable_sort', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'esc_html',
    ) );
    
    $wp_customize->add_setting( 'tg_project_sectors_services_layout', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'esc_html',
    ) );
    
    $wp_customize->add_setting( 'tg_project_items', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'tg_sanitize_slider',
    ) );
    
    $wp_customize->add_setting( 'tg_project_header', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'tg_sanitize_checkbox',
    ) );
    
    $wp_customize->add_setting( 'tg_project_next_prev', array(
        'type'           => 'theme_mod',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'tg_sanitize_checkbox',
    ) );
    //End Project Tab Settings
...
function tg_custom_setting( $controls ) {
	...
	$tg_project_filterable_sort = array(
		'name' => 'By Name',
		'slug' => 'By Slug',
		'id' => 'By ID',
		'count' => 'By Number of Project',
	);
	
	$tg_project_sectors_services_layout = array(
		'project-classic-fullwidth' => 'Project Classic Fullwidth',
		'project-classic-masonry-fullwidth' => 'Project Classic Masonry Fullwidth',
		'project-grid-fullwidth' => 'Project Grid Fullwidth',
		'project-grid-masonry-fullwidth' => 'Project Grid Masonry Fullwidth',
		'project-classic-2' => 'Project Classic 2 Columns',
		'project-classic-3' => 'Project Classic 3 Columns',
		'project-classic-4' => 'Project Classic 4 Columns',
		'project-2-grid' => 'Project Grid 2 Columns',
		'project-3-grid' => 'Project Grid 3 Columns',
		'project-4-grid' => 'Project Grid 4 Columns',
	);
    ...
    $controls[] = array(
        ...
        'section'  => 'logo_favicon',
	    'default'  => get_template_directory_uri().'/images/footer_logo@2x_white.png',
	    'priority' => 4,
    );
    //End Logo Tab Settings
    ...
    $controls[] = array(
        ...
        'output' => array(
	        array(
	            'element'  => 'body, #wrapper, #page_content_wrapper.fixed, #page_content_wrapper .sidebar .content .sidebar_widget li h2.widgettitle span, h2.widgettitle span, #gallery_caption h2, .slider_wrapper .gallery_image_caption h2, #body_loading_screen, h3#reply-title span',
    ...
    $controls[] = array(
        ...
        'output' => array(
	        array(
	            'element'  => 'body, .pagination a, #gallery_caption h2, .slider_wrapper .gallery_image_caption h2, .post_info a',
	            'property' => 'color',
	        ),
	        array(
	            'element'  => '::selection',
    ...
    $controls[] = array(
        'type'     => 'color',
        'setting'  => 'tg_post_category_color',
        'label'    => __( 'Post Category Color', THEMEDOMAIN ),
        'section'  => 'general_color',
        'default'  => '#efc337',
        'output' => array(
	        array(
	            'element'  => '.post_header .post_subtitle a, .post_subtitle a',
	            'property' => 'color',
	        ),
	        array(
	            'element'  => '.post_header .post_subtitle a, .post_subtitle a',
	...
	$controls[] = array(
        ...
        'description' => __('Select menu layout', THEMEDOMAIN ),
        'section'  => 'menu_general',
        'default'  => 1,
	    'priority' => 1,
	    'choices'     => array(
	        1 => __( 'Classic', THEMEDOMAIN ),
	        2 => __( 'Extended', THEMEDOMAIN ),
	        //3 => __( 'Left Align', THEMEDOMAIN ),
	    )
    );
    ...
    $controls[] = array(
        ...
        'output' => array(
	        array(
	            'element'  => '#menu_wrapper div .nav > li.current-menu-item > a, #menu_wrapper div .nav > li.current-menu-parent > a, #menu_wrapper div .nav > li.current-menu-ancestor > a, .top_contact_info i, .top_contact_info',
	            'property' => 'color',
	        ),
	    ),
	    'transport' 	 => 'postMessage',
    ...
    $controls[] = array(
        ...
        'output' => array(
	        array(
	            'element'  => '.mobile_menu_wrapper #searchform input[type=text], .mobile_menu_wrapper #searchform button i, #close_mobile_menu i',
	            'property' => 'color',
	        ),
	    ),
	    'transport' 	 => 'postMessage',
    ...
    $controls[] = array(
        'type'     => 'select',
        'setting'  => 'tg_page_title_alignment',
        ...
        'output' => array(
	        array(
	            'element'  => '#page_caption .page_title_wrapper',
	            'property' => 'text-align',
	        ),
	    ),
	    'transport' 	 => 'postMessage',
    ...
    $controls[] = array(
        ...
        'label'    => __( 'Page Title Background Image Height', THEMEDOMAIN ),
        'section'  => 'header_title_bg',
        'default'  => 400,
        'choices' => array( 'min' => 250, 'max' => 1000, 'step' => 10 ),
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'default'  => 'Ready to take it a step further<br/>
Let’s start purchasing constructor theme<br/>
and find out how it can help create your business website
<br/><br/>
<a href="http://10.0.1.191/sample-page/contact-with-map/" class="button">Get A Quote</a>',
        'transport' 	 => 'postMessage',
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'output' => array(
	        array(
	            'element'  => '#copyright a, #copyright a:active, .social_wrapper ul li a, #footer a, #footer a:active',
	            'property' => 'color',
	        ),
	    ),
	    'transport' 	 => 'postMessage',
    ...
    $controls[] = array(
        ...
        'default'  => '© Copyright Constructor Theme Demo - Theme by ThemeGoods',
        'transport' 	 => 'postMessage',
	    'priority' => 5,
    );
    ...
    $controls[] = array(
        'type'     => 'checkbox',
        'setting'  => 'tg_project_filterable',
        'label'    => __( 'Enable Project Filterable Feature', THEMEDOMAIN ),
        'description' => __('Check this option to enable filterable feature in project pages', THEMEDOMAIN ),
        'section'  => 'project_filterable',
        'default'  => 1,
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        'type'     => 'checkbox',
        'setting'  => 'tg_project_filterable_link',
        'label'    => __( 'Link Project Filterable', THEMEDOMAIN ),
    ...
    $controls[] = array(
        'type'     => 'select',
        'setting'  => 'tg_project_filterable_sort',
        'label'    => __( 'Project Filterable Options Sorting', THEMEDOMAIN ),
        'section'  => 'project_filterable',
        'default'  => 'name',
        'choices'  => $tg_project_filterable_sort,
	    'priority' => 2,
    );
    
    $controls[] = array(
        'type'     => 'select',
        'setting'  => 'tg_project_sectors_services_layout',
        'label'    => __( 'Project Sectors and Services Layout', THEMEDOMAIN ),
        'description' => __('Select page template for displaying project sectors and services contents', THEMEDOMAIN ),
        'section'  => 'project_page',
        'default'  => 'project-classic-fullwidth',
        'choices'  => $tg_project_sectors_services_layout,
	    'priority' => 3,
    );
    
    $controls[] = array(
        'type'     => 'slider',
        'setting'  => 'tg_project_items',
        'label'    => __( 'Project Page Show At Most', THEMEDOMAIN ),
        'description' => __('Select number of project items you want to display per page', THEMEDOMAIN ),
        'section'  => 'project_page',
        'default'  => 24,
    ...
    $controls[] = array(
        'type'     => 'checkbox',
        'setting'  => 'tg_project_header',
        'label'    => __( 'Display Project Header', THEMEDOMAIN ),
        'description' => __('Check this to display featured image as project header background', THEMEDOMAIN ),
    ...
    $controls[] = array(
        'type'     => 'checkbox',
        'setting'  => 'tg_project_next_prev',
        'label'    => __( 'Display Next and Previous Projects', THEMEDOMAIN ),
    ...
    <script type="text/javascript">
        ( function( $ ) {
            ...
            wp.customize('tg_content_bg_color',function( value ) {
                value.bind(function(to) {
                    jQuery('body, #wrapper, #page_content_wrapper.fixed, #page_content_wrapper .sidebar .content .sidebar_widget li h2.widgettitle span, h2.widgettitle span, #gallery_caption h2, .slider_wrapper .gallery_image_caption h2, #body_loading_screen, h3#reply-title span').css('background-color', to );
                });
            });
            
            wp.customize('tg_font_color',function( value ) {
                value.bind(function(to) {
                    jQuery('body, .pagination a, #gallery_caption h2, .slider_wrapper .gallery_image_caption h2, .post_info a').css('color', to );
            ...
            wp.customize('tg_post_category_color',function( value ) {
                value.bind(function(to) {
                    jQuery('.post_header .post_subtitle a, .post_subtitle a').css('color', to );
                    jQuery('.post_header .post_subtitle a, .post_subtitle a').css('border-color', to );
                });
            });
            ...
            wp.customize('tg_menu_active_font_color',function( value ) {
                value.bind(function(to) {
                    jQuery('#menu_wrapper div .nav > li.current-menu-item > a, #menu_wrapper div .nav > li.current-menu-parent > a, #menu_wrapper div .nav > li.current-menu-ancestor > a, .top_contact_info i, .top_contact_info').css('color', to );
                });
            });
            ...
            wp.customize('tg_topbar_font_color',function( value ) {
                value.bind(function(to) {
                    jQuery('#top_menu li a').css('color', to );
                });
            });
            ...
            wp.customize('tg_page_title_alignment',function( value ) {
                value.bind(function(to) {
                    jQuery('#page_caption .page_title_wrapper').css('textAlign', to );
                });
            });
            
            wp.customize('tg_page_title_bg_height',function( value ) {
                value.bind(function(to) {
                    jQuery('#page_caption.hasbg').css('height', to+'px' );
                });
            });
            ...
            wp.customize('tg_footer_link_color',function( value ) {
                value.bind(function(to) {
                    jQuery('#copyright a, #copyright a:active, .social_wrapper ul li a, #footer a, #footer a:active').css('color', to );
                });
            });
