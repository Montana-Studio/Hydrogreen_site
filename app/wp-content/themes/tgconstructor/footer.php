...
<div class="footer_bar <?php if(isset($pp_homepage_style) && !empty($pp_homepage_style)) { echo esc_attr($pp_homepage_style); } ?>">
		...
		<div class="footer_before_widget">
			<a href="<?php echo home_url(); ?>" class="logo_wrapper footer_logo">
				<?php
					...
					{
				?>
				<img src="<?php echo esc_url($tg_retina_footer_logo); ?>" alt="" width="<?php echo $image_width; ?>" height="<?php echo $image_height; ?>"/>
				<?php
					}
					else
					{
				?>
	    	    <img src="<?php echo esc_url($tg_retina_footer_logo); ?>" alt=""/>
	    	    <?php 
	    	    	}
	    	    ?>
	    	</a>
	...
	?>
	<div id="footer_before_widget_text"><?php echo wp_kses_post(htmlspecialchars_decode($tg_footer_text)); ?></div>
			...
			<div class="social_wrapper">
			    <ul>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li class="facebook"><a <?php if(!empty($tg_footer_social_link)) { ?>target="_blank"<?php } ?> href="<?php echo esc_url($pp_facebook_username); ?>"><i class="fa fa-facebook"></i></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
			    	...
			    	<?php
			    		...
			    		{
			    	?>
			    	<li class="google"><a <?php if(!empty($tg_footer_social_link)) { ?>target="_blank"<?php } ?> title="Google+" href="<?php echo esc_url($pp_google_username); ?>"><i class="fa fa-google-plus"></i></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
