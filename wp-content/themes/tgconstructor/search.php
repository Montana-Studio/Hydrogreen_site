	...
	<div class="post_wrapper">
	    ...
	    <div class="post_content_wrapper">
			...
			<div class="one">
				...
				?>
					<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr($post_type_title); ?>" class="tooltip"><?php echo esc_html($post_type_class); ?></a>
				<?php
					if(!isset($post_thumb[0]))
					{
				?>
			    ...
			    <div class="post_header search">
				    ...
				    <?php
				    	echo pp_substr(strip_shortcodes(get_the_content()), 100);
				    ?>
			    </div>
			</div>
	    </div>
